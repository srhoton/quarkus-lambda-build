...
/**
 * Represents the input data structure for Lambda functions. This class serves as the request model
 * for the Lambda handlers.
 *
 * <p>Contains fields for name and greeting that will be used to generate a personalized greeting
 * message.
 */
